        ...
        <div className="p-8 font-sans">
            ...
            <div className="flex justify-between items-center mb-8">
                ...
                <button
                    ...
                    className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center gap-2 text-sm font-medium transition-all shadow-sm"
                >
                        ...
                        {dummyPayslipData.map((payslip) => (
                            <tr key={payslip._id} className="hover:bg-gray-50">
                                ...
                                <td className="px-6 py-4 text-right">
                                    <button className="inline-flex items-center gap-2 px-3 py-1.5 text-xs font-medium text-blue-600 border border-blue-200 rounded-md hover:bg-blue-50">
